...
return [
    ...
    "startpage"  => [
        ...
        "info"  => [
            ...
            "3"      => 'In the middle of the start page is the search field.<br> Below the search field, it says <strong>Install MetaGer.</strong>. <br> You can click on it.<br> That way, you can download MetaGer.<br>Then you can set MetaGer as your default search engine<a title="The standard search engine is the search engine you always use. Click here for more information here" href="/hilfe/easy-language/glossary#standardsuche" ><img class="glossary-icon lm-only" src="/img/glossary-icon-lm.svg"/><img class="glossary-icon dm-only" src="/img/glossary-icon-dm.svg"/></a>.',
    ...
    "resultpage"  => [
        ...
        "foci"  => [
            "1"       => 'Below the search field, there is a row with several buttons. <br>These are different search categories.<a title="Results are sorted to make them easier to find. Click here for more information." href="/hilfe/easy-language/glossary#suchkategorien" ><img class="glossary-icon lm-only" src="/img/glossary-icon-lm.svg"/><img class="glossary-icon dm-only" src="/img/glossary-icon-dm.svg"/></a>. <br> This is what the row looks like:',
        ...
        "filter"  => [
            "title"     => 'Filter:',
            "1"     => 'If you click on Filter<a title="With this, you can determine what the search engine should display. Click here for more information" href="/hilfe/easy-language/glossary#filter" ><img class="glossary-icon lm-only" src="/img/glossary-icon-lm.svg"/><img class="glossary-icon dm-only" src="/img/glossary-icon-dm.svg"/></a>, you can filter your search. <br> Hier können Sie ihre Such-Ergebnisse filtern. <br> Each search category has different filtering options.<br> For example, you can search for results from the last 30 days.<br>Then you will only see results from the past 30 days.<br>You can set the filter in our settings.',
        ],
        "settings" => [
            "title" => 'Settings:',
    ...
    "result" => [
        ...
        "info" => [
            ...
            "more" => [
                ...
                "1" => 'When you click on <img id="help-ellipsis-image" src="/img/ellipsis.svg"/>, there are new options. <br> The result will look different. <br> It will look like this:',
            ],
            ...
            "domainnewsearch" => [
                ...
                "2" => 'Example:',
                "3" => 'You find a result from the Duden website. <br> You click on <img id="help-ellipsis-image" src="/img/ellipsis.svg"/> for that result. <br> Then you click on the button <strong>start a new search on this domain<a title="Word explanation" href="/hilfe/easy-language/glossary#domain" ><img class="glossary-icon lm-only" src="/img/glossary-icon-lm.svg"/><img class="glossary-icon dm-only" src="/img/glossary-icon-dm.svg"/></a></strong>. <br> Then you search again, but only on the Duden website.',
            ],
            "hideresult" => [
                "title" => 'Hide:',
    ...
    "settings" => [
        ...
        "cookies" => [
            ...
            "1" => 'Some browsers delete your cookies after a session. <br> This also deletes the MetaGer settings. <br> You can restore the settings using the link. <br> You can save this link as your homepage. <br> Then, when you open the browser, the settings will be restored. ',
        ],
        "searchengine" => [
        ...
        "filter" => [
            ...
            "1" => [
                "0" => 'With the search filter, you can filter your search. <br> You can choose what you want to see.',
                "1" => 'Date:',
            ...
            "2" => 'SafeSearch:',
            "3" => 'With the SafeSearch filter (youth protection filter), you can hide unpleasant results. <br> <strong>Strict</strong> finds almost no unpleasant results. <br> <strong>Off</strong> finds all results, including unpleasant results. <br> <strong>Moderate</strong> finds some unpleasant results. <br> With <strong>Any</strong>, each search engine decides for itself. <br> The moderate mode requires a MetaGer Key.',
        ],
        "blacklist" => [
            "title" => 'Blacklist:',
        ...
        "newtab" => [
            ...
            "1" => 'Here you can view the results in a new tab. <br> This applies to each result.',
        ],
        "cite" => [
            "title" => 'Citations:',
