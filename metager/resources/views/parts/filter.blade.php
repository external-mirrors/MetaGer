<div id="options">
	<div id="toggle-box">
		<div id="settings">
			<a id="settings-link" href="{{ route('settings', ["focus" => $metager->getFokus(), "url" => $metager->generateSearchLink($metager->getFokus())]) }}" @if(!empty($metager) && $metager->isFramed())target="_top" @endif>
