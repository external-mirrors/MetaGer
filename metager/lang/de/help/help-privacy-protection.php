...
return [
    ...
    "tor" => [
        "title" => 'Tor-Hidden-Service <a title="Zur einfachen Hilfe" href="/hilfe/easy-language/privacy-protection#torhidden" ><img class="easy-help-icon lm-only" src="/img/help-questionmark-icon-lm.svg"/><img class="easy-help-icon dm-only" src="/img/help-questionmark-icon-dm.svg"/></a>',
   ...
   "proxy" => [
        "title" => 'Anonymisierender MetaGer-Proxyserver <a title="Zur einfachen Hilfe" href="/hilfe/easy-language/privacy-protection#proxy" ><img class="easy-help-icon lm-only" src="/img/help-questionmark-icon-lm.svg"/><img class="easy-help-icon dm-only" src="/img/help-questionmark-icon-dm.svg"/></a>',
   ...
   "content" => [
        'title' => 'Fragwürdige Inhalte / Jugendschutz <a title="Zur einfachen Hilfe" href="/hilfe/easy-language/privacy-protection#content" ><img class="easy-help-icon lm-only" src="/img/help-questionmark-icon-lm.svg"/><img class="easy-help-icon dm-only" src="/img/help-questionmark-icon-dm.svg"/></a>',
        "explanation" => [
