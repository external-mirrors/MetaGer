...
<section class="help-section">
	...
	<section id="help-searchfunctions" class="help-section card">
		...
		<div>
			...
			<ul class="dotlist">
				<li class="nodot">
					<div class="search-example">{!! trans('help/easy-language/help-functions.stopworte.3') !!}</div></li>
			</ul>
		...
		<div>
			...
			<ul class="dotlist">
				...
				<li class="nodot">
					<div class="search-example">{!! trans('help/easy-language/help-functions.mehrwortsuche.3.example') !!}</div></li>
			</ul>
			...
			<ul class="dotlist">
				...
				<li class="nodot">
					<div class="search-example">{!! trans('help/easy-language/help-functions.mehrwortsuche.5.example') !!}</div></li>
			</ul>
		</div>
		{{--
		...
		<div>
			...
			<ul class="dotlist">
				...
				<li class="nodot">
					<div class="search-example">{!! trans('help/easy-language/help-functions.exactsearch.example.1') !!}</div></li>
				<p>{!! trans('help/easy-language/help-functions.exactsearch.3') !!}</p>
				<li>{!! trans('help/easy-language/help-functions.exactsearch.4') !!}</li>
				<li class="nodot">
					<div class="search-example">{!! trans('help/easy-language/help-functions.exactsearch.example.2') !!}</div></li>
			</ul>
		</div>
		--}}
	</section>
	<section id="eh-bangs" class="help-section card">
		...
		<div>
			...
			@if (App\Localization::getLanguage() == "de")
				<img id="help-easy-language-bang-image" class="help-easy-language-image lm-only"
					src="/img/help/help-bangs-lm.png" />
				<img class="help-easy-language-image dm-only" src="/img/help/help-bangs-dm.png" />
			@else
				<img id="help-easy-language-bang-image" class="help-easy-language-image lm-only"
					src="/img/help/help-bangs-lm-en.png" />
	...
	<section id="eh-keyexplain" class="help-section card">
		...
		<div>
			...
			<ul>
				...
				@if (App\Localization::getLanguage() == "de")
					<img class="help-easy-language-image help-easy-language-key-image lm-only"
						src="/img/help/help-key-add-lm.png" />
					<img class="help-easy-language-image help-easy-language-key-image dm-only"
						src="/img/help/help-key-add-dm.png" />
				@else
					<img class="help-easy-language-image help-easy-language-key-image lm-only"
						src="/img/help/help-key-add-lm-en.png" />
					<img class="help-easy-language-image help-easy-language-key-image dm-only"
						src="/img/help/help-key-add-dm-en.png" />
				@endif
				<p>{!! trans('help/easy-language/help-functions.key.4.2') !!}</p>
				@if (App\Localization::getLanguage() == "de")
					<img class="help-easy-language-image help-easy-language-key-image lm-only"
						src="/img/help/help-key-add-file-lm.png" />
					<img class="help-easy-language-image help-easy-language-key-image dm-only"
						src="/img/help/help-key-add-file-dm.png" />
				@else
					<img class="help-easy-language-image help-easy-language-key-image lm-only"
						src="/img/help/help-key-add-file-lm-en.png" />
					<img class="help-easy-language-image help-easy-language-key-image dm-only"
						src="/img/help/help-key-add-file-dm-en.png" />
				@endif
				...
				@if (App\Localization::getLanguage() == "de")
					<img class="help-easy-language-image help-easy-language-key-image lm-only"
						src="/img/help/help-key-qr-code-lm.png" />
					<img class="help-easy-language-image help-easy-language-key-image dm-only"
						src="/img/help/help-key-qr-code-dm.png" />
				@else
					<img class="help-easy-language-image help-easy-language-key-image lm-only"
						src="/img/help/help-key-qr-code-lm-en.png" />
					<img class="help-easy-language-image help-easy-language-key-image dm-only"
						src="/img/help/help-key-qr-code-dm-en.png" />
				@endif
	...
	<section id="eh-selist" class="help-section card">
		...
		@if (App\Localization::getLanguage() == "de")
			<img id="help-easy-language-install-metager-image" class="help-easy-language-image lm-only"
				src="/img/help/help-install-metager-lm.png" />
			<img class="help-easy-language-image dm-only" src="/img/help/help-install-metager-dm.png" />
		@else
			<img id="help-easy-language-install-metager-image" class="help-easy-language-image lm-only"
				src="/img/help/help-install-metager-lm-en.png" />
