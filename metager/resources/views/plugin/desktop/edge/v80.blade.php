<div class="card">
	...
	<p>
		{!! trans('plugin-desktop/desktop-edge.plugin') !!}
	</p>
</div>
<div class="card">
...
<div class="card">
	...
	<ol>
		...
		<li>{{ trans('plugin-desktop/desktop-edge.default-page-v80.2', ['link' => LaravelLocalization::getLocalizedURL(LaravelLocalization::getCurrentLocale(), "/")]) }}
		</li>
