...
<div class="sidebar">
  ...
  <ul class="sidebar-list">
    ...
    <li class="metager-dropdown">
      ...
      <img src="/img/icon-more-information.svg" alt="{{ trans('sidebar.alt.info') }}" aria-hidden="true" id="sidebar-img-info"> 
  ...
  <ul class="sidebar-list">
    ...
    <li>
      ...
      <img src="/img/icon-map.svg" alt="{{ trans('sidebar.alt.map') }}" aria-hidden="true" id="sidebar-img-map"> 
  ...
  <ul class="sidebar-list">
    <li class="metager-dropdown">
      ...
      <img src="/img/icon-contact.svg" alt="{{ trans('sidebar.alt.contact') }}" aria-hidden="true" id="sidebar-img-contact"> 
    ...
    <li class="metager-dropdown">
      <input id="servicesToggle" class="sidebarCheckbox" type="checkbox">
        ...
        <img src="/img/icon-services.svg" alt="{{ trans('sidebar.alt.services') }}" aria-hidden="true" id="sidebar-img-services"> 
      ...
      <ul class="metager-dropdown-content">
        ...
        @if(App\Localization::getLanguage() == "de")
          <li>
            <a href="https://shop.spreadshirt.de/metager/" rel="noopener" target="_blank">{{ trans('sidebar.nav26') }}<img src="/img/icon-outlink.svg" alt="{{ trans('sidebar.alt.outlink') }}" aria-hidden="true" id="sidebar-img-outlink"></a> 
          </li>
        @endif
        <li>
    ...
    <li class="metager-dropdown">
      ...
      <img src="/img/icon-settings.svg" alt="{{ trans('sidebar.alt.language') }}" aria-hidden="true" id="sidebar-img-language"> 
