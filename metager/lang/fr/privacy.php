...
return [
    ...
    'contexts' => [
        ...
        'metager' => [
            ...
            'advertisers' => 'Outre les dons et les cotisations des membres, nous devons financer nos activités par de la publicité non personnalisée sur la page de résultats. Pour recevoir cette publicité, nous communiquons à nos partenaires publicitaires les deux premiers blocs de l\'adresse IP en relation avec des parties de ce que l\'on appelle l\'agent utilisateur.',
            'clarity' => 'Nous travaillons avec Microsoft Clarity et Microsoft Advertising pour vous offrir gratuitement des résultats de recherche et de la publicité sur Yahoo. À cette fin, des données d\'utilisation à des fins statistiques sont enregistrées sur la page de résultats de MetaGer.',
        ],
        'contact' => [
