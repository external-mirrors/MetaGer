...
return [
	...
	'paragraph.2'	=> 'Daür gibt es verschiedene Möglichkeiten. Um die Qualität von Informationen zu prüfen, gibt es den sogenannten <a href="https://library.csuchico.edu/sites/default/files/craap-test.pdf">"CRAAP-Test"</a>. Dieser wurde von der Meriam Library California State University Chico entwickelt. Dieser Test bietet viele hilfreiche Fragen, um zu schauen, ob diese Informationen zuverlässig sind. Zusätzlich zu diesem Test können Sie hier weitere hilfreiche Informationen finden.',
	'list.1'		=> 'Webseiten',
	'list.1.1'		=> '<strong>Datum</strong>: Bei guten Quellen ist meistens immer ein Datum angegeben, wann dieser Artikel veröffentlicht wurde. Dies ist also ein Indiz, was auf die Qualität der Informationen hinweisen kann.',
	'list.1.2'		=> '<strong>Autor</strong>: Ist ein Autor genannt? Bei den meisten guten Quellen ist immer ein Auto benannt. Auch dies ist eine wichtige Angabe. Wenn ein Autor angegeben ist, ist es oft sinnvoll zu schauen, ob diese Person öfter etwas zu diesen Themen publiziert.  Zusätzlich kann man schauen, ob diese Person in dem (Fach)gebiet bekannt ist oder es Wikipedia-Einträge zu dieser gibt.',
	...
	'list.2.5'		=> 'Wie viele Abonennten oder Freunde hat dieses Profil? Was kann über die Namen dieser Personen herausgefunden werden?',
	'list.3'		=> 'Wikipedia',
	...
	'list.4'		=> 'E-Mails',
	'list.4.1'		=> 'E-Mails fälschen ist sehr einfach. Es gibt somit sehr viele Fakemails- Wie kann man dies nun überprüfen?',
	'list.4.2'		=> 'Stammt die Mail wirklich von dem angegebenen Absender? Dazu prüft man denHeader der E-Mail. Zusätzlich kann man die dort genannten IP-Adressen und Zustellwege untersuchen. Dies ist jedoch nicht einfach.',
