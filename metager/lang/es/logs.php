...
return [
    ...
    'api_keys' => [
        ...
        'heading' => "Clave API",
        'hint' => "Para poder utilizar la API, debe autenticarse. Aquí puede crear una clave de API para sus equipos. <b>Nota:</b>: Las tarjetas recién instaladas sólo están disponibles una vez. Por favor, especifíquelas después de la instalación.",
        'copy' => "Copia",
        'delete' => "Borrar",
    ],
    'overview' => [
