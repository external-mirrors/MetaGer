	...
	<div class="result-header">
		<div class="result-headline">
			<h2 class="result-title" title="{{ $result->titel }}">
				...
				@endif
				<a href="{{ $result->link }}" target="{{ $metager->newtab }}" rel="noopener">
					{!! $result->titel !!}
				</a>
			</h2>
		...
		<div class="result-subheadline">
			<a class="result-link" href="{{ $result->link }}" title="{{ $result->anzeigeLink }}" rel="noopener" target="{{ $metager->newtab }}" tabindex="-1">
				{{ $result->anzeigeLink }}
			</a>
