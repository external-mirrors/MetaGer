...
return [
    ...
    'head.4.' => 'What makes MetaGer special?',
    ...
    'text.2' => 'MetaGer is different from other search engines. This is reflected not only in our public benefit orientation and focus on privacy, but also through some unique features:',
    'text.3' => 'Possibility of creating a personal blacklist',
    'text.4' => 'Search in search function',
    'text.5' => 'Ad-free search possible (for members)',
    'text.6' => 'Integration of search engine projects like YaCy',
    'text.7' => 'The only German search engine that combines results from several large web indexes',
    'text.8' => 'And much more…',
    ...
    'timeline.18' => '14.02.2022: Renewal of the Helppage',
    'timeline.18.1' => 'MetaGer has added a new overview help page. This structures and visualizes the help pages through easy to recognize symbols.',

    'timeline.19' => 'Today',
    'timeline.19.1' => 'Even today, MetaGer is constantly evolving.'
];
