...
return [
    ...
    'supportedLocales' => [
        ...
        'en-AU' => ['name' => 'English (Australia)', 'script' => 'Latn', 'native' => 'English (Australia)', 'regional' => 'en_AU'],
        'en-MY' => ['name' => 'English (Malaysia)', 'script' => 'Latn', 'native' => 'English (Malaysia)', 'regional' => 'en_MY'],
        ...
        'pl-PL' => ['name' => 'Polish (Poland)', 'script' => 'Latn', 'native' => 'Polski (Polska)', 'regional' => 'pl_PL'],
        'pt-PT' => ['name' => 'Portuguese (Portugal)', 'script' => 'Latn', 'native' => 'Portugues (Portugal)', 'regional' => 'pt_PT'],
        'pt-BR' => ['name' => 'Portuguese (Brazil)', 'script' => 'Latn', 'native' => 'Português (Brasil)', 'regional' => 'pt_BR'],
