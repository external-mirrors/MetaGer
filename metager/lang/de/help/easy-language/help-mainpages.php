...
return [
    ...
    "resultpage"  => [
        ...
        "filter"  => [
            "title"     => 'Filter:',
            "1"     => 'Wenn Sie auf Filter<a title="Wort erklärung" href="/hilfe/easy-language/glossary#filter" ><img class="glossary-icon lm-only" src="/img/glossary-icon-lm.svg"/><img class="glossary-icon dm-only" src="/img/glossary-icon-dm.svg"/></a> klicken, können Sie ihre Suche filtern. <br> Hier können Sie ihre Such-Ergebnisse filtern. <br> Jede Such-Kategorie hat verschiedene Möglichkeiten zum Filtern.<br> Sie können zum Beispiel nach Ergebnissen der letzten 30 Tagen suchen.<br> Dann sehen Sie nur Ergebnisse von den letzen 30 Tagen.<br> In unseren Einstellungen können Sie den Filter einstellen.',
        ],
        "settings"  => [
            "title" => 'Einstellungen:',
    ...
    "settings"  => [
        ...
        "cookies"  => [
            ...
            "1" => 'Manche Browser<a title="Wort erklärung" href="/hilfe/easy-language/glossary#browser" ><img class="glossary-icon lm-only" src="/img/glossary-icon-lm.svg"/><img class="glossary-icon dm-only" src="/img/glossary-icon-dm.svg"/></a> löschen Ihre Cookies<a title="Wort erklärung" href="/hilfe/easy-language/glossary#cookies" ><img class="glossary-icon lm-only" src="/img/glossary-icon-lm.svg"/><img class="glossary-icon dm-only" src="/img/glossary-icon-dm.svg"/></a> nach einer Sitzung. <br> Dann werden auch die Einstellungen von MetaGer gelöscht. <br> Mit dem Link können Sie die Einstellungen wieder her-stellen. <br> Sie können diesen Link als Start-Seite speichern. <br> Dann sind beim Öffnen des Browsers<a title="Wort erklärung" href="/hilfe/easy-language/glossary#browser" ><img class="glossary-icon lm-only" src="/img/glossary-icon-lm.svg"/><img class="glossary-icon dm-only" src="/img/glossary-icon-dm.svg"/></a> die Einstellungen wieder da. ',
        ],
        "searchengine"  => [
            "title" => 'Verwendete Such-Maschinen:',
            "1" => 'Hier sehen Sie alle Such-Maschinen<a title="Wort erklärung" href="/hilfe/easy-language/glossary#suchmaschine" ><img class="glossary-icon lm-only" src="/img/glossary-icon-lm.svg"/><img class="glossary-icon dm-only" src="/img/glossary-icon-dm.svg"/></a> die MetaGer nutzt. <br> Sie können auswählen welche Such-Maschinen<a title="Wort erklärung" href="/hilfe/easy-language/glossary#suchmaschine" ><img class="glossary-icon lm-only" src="/img/glossary-icon-lm.svg"/><img class="glossary-icon dm-only" src="/img/glossary-icon-dm.svg"/></a> Sie nutzen wollen. <br> Sie können auf die einzelnen Knöpfe klicken. <br> Wenn die Knöpfe durchgestrichen sind, dann nutzen Sie die Such-Maschinen<a title="Wort erklärung" href="/hilfe/easy-language/glossary#suchmaschine" ><img class="glossary-icon lm-only" src="/img/glossary-icon-lm.svg"/><img class="glossary-icon dm-only" src="/img/glossary-icon-dm.svg"/></a> nicht. <br> Einige Such-Maschinen sind nur mit einem <a href = "/hilfe/easy-language/funktionen#keyexplain">MetaGer-Schlüssel</a> nutzbar.',
            "2" => 'Such-Maschinen die man nur mit MetaGer Schlüssel verwenden kann, sind ausgegraut.',
        ],
        "filter"  => [
            "title" => 'Such-Filter<a title="Wort erklärung" href="/hilfe/easy-language/glossary#filter" ><img class="glossary-icon lm-only" src="/img/glossary-icon-lm.svg"/><img class="glossary-icon dm-only" src="/img/glossary-icon-dm.svg"/></a>:', 
            "1"  => [   
                "0" => 'Mit dem Such-Filter<a title="Wort erklärung" href="/hilfe/easy-language/glossary#filter" ><img class="glossary-icon lm-only" src="/img/glossary-icon-lm.svg"/><img class="glossary-icon dm-only" src="/img/glossary-icon-dm.svg"/></a> können Sie Ihre Suche filtern. <br> Sie können also auswählen was Sie sehen wollen.',
                "1" => 'Datum:',
            ...
            "2" => 'Safesearch<a title="Wort erklärung" href="/hilfe/easy-language/glossary#safesearch" ><img class="glossary-icon lm-only" src="/img/glossary-icon-lm.svg"/><img class="glossary-icon dm-only" src="/img/glossary-icon-dm.svg"/></a>:', 
            "3" => 'Mit dem Safesearch<a title="Wort erklärung" href="/hilfe/easy-language/glossary#safesearch" ><img class="glossary-icon lm-only" src="/img/glossary-icon-lm.svg"/><img class="glossary-icon dm-only" src="/img/glossary-icon-dm.svg"/></a> Filter (Jugendschutz-Filter) verstecken Sie unangenehme Ergebnisse. <br> <strong>Strikt</strong> findet fast keine unangenehmen Ergebnisse. <br> <strong>Aus</strong> findet alle Ergebnisse, also auch unangenehme Ergebnisse. <br> <strong>Moderat</strong> findet ein paar unangenehme Ergebnisse. <br> Bei <strong>Beliebig</strong> entscheiden die einzelnen Such-Maschinen selber. <br> Für den moderaten Modus braucht man einen MetaGer Schlüssel.', 
        ],
        "blacklist"  => [
        ...
        "newtab"  => [
            ...
            "1" => 'Hier können Sie die Ergebnisse in einem neuen Tab<a title="Wort erklärung" href="/hilfe/easy-language/glossary#tab" ><img class="glossary-icon lm-only" src="/img/glossary-icon-lm.svg"/><img class="glossary-icon dm-only" src="/img/glossary-icon-dm.svg"/></a> anzeigen. <br> Das geht dann immer für jedes Ergebnis.',
        ],
        "cite"  => [
        "title" => 'Zitate:',
