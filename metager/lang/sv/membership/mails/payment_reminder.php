...
return [
    ...
    'terminate' => 'Utan mottagande av betalning måste vi tyvärr säga upp ditt medlemskap i [SUMA-EV](https://suma-ev.de) från och med <b>:expiration</b>',
    'description' => 'Din medlemsavgift förföll till betalning den **:date**. Vänligen överför det utestående beloppet på **:amount** till vårt bankkonto senast **:due**, med angivande av skälet till betalningen (**:payment_reference**):',
    'description_rejoin' => 'Om så är fallet kan du bara överföra din medlemsavgift på **:amount** till vårt bankkonto och ange orsaken till betalningen (**:payment_reference**):',
];
