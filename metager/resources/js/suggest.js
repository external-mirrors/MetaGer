...
(() => {
    ...
    function updateSuggestions() {
        ...
        // Add all Partners
        suggestions_container.querySelectorAll(".partner").forEach((value, index) => {
        ...
        // Add all Suggestions
        suggestions_container.querySelectorAll(".suggestion").forEach((value, index) => {
            ...
            value.href = "#";
            let title_container = value.querySelector("div");
            if (title_container) {
