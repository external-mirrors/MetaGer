...
return [
    ...
    'title' => 'MetaGer - Help',
    "selist" => [
        'title' => 'Add MetaGer to Your Browser\'s Search Engine List <a title="For easy help, click here" href="/hilfe/easy-language/functions#selist"><img class="easy-help-icon lm-only" src="/img/help-questionmark-icon-lm.svg"/><img class="easy-help-icon dm-only" src="/img/help-questionmark-icon-dm.svg"/></a>',
    ...
    "stopwords" => [
        "title" => 'Stopwords <a title="For easy help, click here" href="/hilfe/easy-language/functions#stopwordsearch"><img class="easy-help-icon lm-only" src="/img/help-questionmark-icon-lm.svg"/><img class="easy-help-icon dm-only" src="/img/help-questionmark-icon-dm.svg"/></a>',
        "3" => "car new -bmw",
    ...
    "key"    => [
        "title" => 'Add MetaGer Key <a title="For easy help, click here" href="/hilfe/easy-language/functions#keyexplain"><img class="easy-help-icon lm-only" src="/img/help-questionmark-icon-lm.svg"/><img class="easy-help-icon dm-only" src="/img/help-questionmark-icon-dm.svg"/></a>',
    ...
    "multiwordsearch" => [
        "title" => 'Multi-Word Search <a title="For easy help, click here" href="/hilfe/easy-language/functions#severalwords"><img class="easy-help-icon lm-only" src="/img/help-questionmark-icon-lm.svg"/><img class="easy-help-icon dm-only" src="/img/help-questionmark-icon-dm.svg"/></a>',
        "4" => [
    ...
    "bang"  => [
        "title" => '!bangs <a title="For easy help, click here" href="/hilfe/easy-language/functions#bangs"><img class="easy-help-icon lm-only" src="/img/help-questionmark-icon-lm.svg"/><img class="easy-help-icon dm-only" src="/img/help-questionmark-icon-dm.svg"/></a>',
    ...
    "backarrow" => 'Back',
    "easy-help"=> 'By clicking on the symbol <a title="For easy help, click here" href="/hilfe/easy-language/functions#bangs"><img class="easy-help-icon lm-only" src="/img/help-questionmark-icon-lm.svg"/><img class="easy-help-icon dm-only" src="/img/help-questionmark-icon-dm.svg"/></a>, you will access a simplified version of the help.',
];
