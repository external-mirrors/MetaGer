...
return [
    ...
    "maps" => [
        ...
        "title" => 'MetaGer Maps <a title="For easy help, click here" href="/hilfe/easy-language/services#maps" ><img class="easy-help-icon lm-only" src="/img/help-questionmark-icon-lm.svg"/><img class="easy-help-icon dm-only" src="/img/help-questionmark-icon-dm.svg"/></a>',
    ],
    "searchword-associator" => [
        "1" => 'As an aid to explore a term field, we have developed the <a href="/asso" target="_blank" rel="noopener">MetaGer Web Associator</a>. You can also find the tool directly under the "Services" tab. If you enter a search term that is somehow related to the field you want to investigate, the tool will attempt to extract typical technical terms from the web.',
        "2" => "Example: You want to learn more about tick bites and their dangers, but you can't remember the medical terms for diseases in this area. Entering the word 'tick bites' into the Web Associator will provide terms such as 'Lyme disease' and 'TBE'.",
        "3" => "Since this association analysis is also obtained from web documents themselves, it is language-independent; i.e., you can gain technical terms from any language when entering German words (and vice versa).",
        "title" => 'Search Word Associator <a title="For easy help, click here" href="/hilfe/easy-language/services#asso" ><img class="easy-help-icon lm-only" src="/img/help-questionmark-icon-lm.svg"/><img class="easy-help-icon dm-only" src="/img/help-questionmark-icon-dm.svg"/></a>',
    ],
    "title" => 'MetaGer - Help',
    "widget" => [
        ...
        "title" => 'MetaGer Widget <a title="For easy help, click here" href="/hilfe/easy-language/services#widget" ><img class="easy-help-icon lm-only" src="/img/help-questionmark-icon-lm.svg"/><img class="easy-help-icon dm-only" src="/img/help-questionmark-icon-dm.svg"/></a>',
    ],
];
