...
<div>
	...
	<div class="enginecontainer">
		...
		<div class="card">
			<h2>{{ trans('search-engine.head.12') }}</h2>
			<p><span class="search-engine-dt">{{ trans('search-engine.text.2.1')}}</span>{{ trans('search-engine.text.12.1')}}</p>
			<p><span class="search-engine-dt">{{ trans('search-engine.text.2.3') }}</span>{{ trans('search-engine.text.12.2') }}</p>
			<p><span class="search-engine-dt">{{ trans('search-engine.text.2.4') }}</span>{{ trans('search-engine.text.12.3') }}</p>
			<p><span class="search-engine-dt">{{ trans('search-engine.text.2.5') }}</span>{{ trans('search-engine.text.12.4') }}</p>
			<p><span class="search-engine-dt">{{ trans('search-engine.text.2.6') }}</span>{{ trans('search-engine.text.12.5') }}</p>
			<p><span class="search-engine-dt">{{ trans('search-engine.text.2.7') }}</span>{{ trans('search-engine.text.12.6') }}</p>
		</div>
	</div>
</div>
@endsection