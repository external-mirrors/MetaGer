...
return [
    "app" => [
        ...
        "title" => 'Android-App <a title="Zur leichten Hilfe" href="/hilfe/easy-language/services#help-app" ><img class="easy-help-icon lm-only" src="/img/help-questionmark-icon-lm.svg"/><img class="easy-help-icon dm-only" src="/img/help-questionmark-icon-dm.svg"/></a>',
    ],
    "backarrow"             => 'Zurück',
    "dienste"   => [
    ...
    "maps" => [
        ...
        "title" => 'MetaGer Maps <a title="Zur leichten Hilfe" href="/hilfe/easy-language/services#maps" ><img class="easy-help-icon lm-only" src="/img/help-questionmark-icon-lm.svg"/><img class="easy-help-icon dm-only" src="/img/help-questionmark-icon-dm.svg"/></a>',
    ],
    "suchwortassoziator" => [
        ...
        "title" => 'Suchwortassoziator <a title="Zur leichten Hilfe" href="/hilfe/easy-language/services#asso" ><img class="easy-help-icon lm-only" src="/img/help-questionmark-icon-lm.svg"/><img class="easy-help-icon dm-only" src="/img/help-questionmark-icon-dm.svg"/></a>',
    ],
    "title" => 'MetaGer - Hilfe',
    "widget" => [
        ...
        "title" => 'MetaGer Widget <a title="Zur leichten Hilfe" href="/hilfe/easy-language/services#widget" ><img class="easy-help-icon lm-only" src="/img/help-questionmark-icon-lm.svg"/><img class="easy-help-icon dm-only" src="/img/help-questionmark-icon-dm.svg"/></a>',
    ],
];
