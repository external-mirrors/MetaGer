...
return [
    ...
    'timeline.1.1' => 'The idea of MetaGer arose during the CeBIT computer fair over lunch on a paper napkin. Work on the first prototype begins that same evening. ',
   
    'timeline.2' => 'End of 1996: Launch of MetaGer',
    'timeline.2.1' => 'MetaGer is being developed as a research project by the University of Hanover and the regional data center in Lower Saxony. ',
    ...
    'timeline.7.1' => 'MetaGer offers access within the Tor anonymization network as a security-related feature.',
    ...
    'timeline.9.1' => 'As part of more extensive modernizations, a new simplified home page is offered.',

    'timeline.10' => 'March 2016: Search results under 1.3 seconds',
    'timeline.10.1' =>'Extensive modernization at the core of MetaGer reduces the average response time of the search engine to less than 1.3 seconds. Over the next few years, this drops further to almost half.',
    ...
    'timeline.13.1' => 'Maps.MetaGer.de is launched as a privacy-friendly map service. The maps are based on data from the OpenStreetMap project, but have their own display and route planners.',
    ...
    'timeline.15.1' => 'The Quicktips, which offer hints beyond normal search results, have been expanded in functionality and spun off into a separate project. Instead of being located above the results, they are now in a sidebar.',
    ...
    'timeline.17' => '26.10.2020: Current start page and dark mode',
    'timeline.17.1' => 'As part of an extensive redesign of the start page, MetaGer\'s four unique selling points have been revisited and presented in an expanded form. In order not to overload the central function of the web search, the descriptions can be reached by scrolling. <br> Another feature of the new revision is the page-wide dark mode. This allows MetaGer to be used on all pages in a dark design.',
