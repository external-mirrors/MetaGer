...
return [
    ...
    'proxy' => [
        'title' => 'Anonym webbläsare <a title="For easy help, click here" href="/hilfe/easy-language/privacy-protection#eh-proxy" ><img class="easy-help-icon lm-only" src="/img/help-questionmark-icon-lm.svg"/><img class="easy-help-icon dm-only" src="/img/help-questionmark-icon-dm.svg"/></a>',
        '1' => 'För att använda den behöver du bara klicka på "ÖPPNA ANONYMT" längst ner i ett resultat på MetaGers resultatsida. Ett separat fönster öppnas då med en riktig, isolerad webbläsare som körs på våra servrar – inte på din enhet. Sessionen startar direkt på sidan du ville öppna. Denna webbläsare har ett eget adressfält och egna flikar, som du kan använda helt normalt: du kan klicka vidare, ange nya adresser och öppna nya flikar utan att förlora ditt skydd. Målwebbplatsen får aldrig reda på din IP-adress eller andra uppgifter om dig. Allt raderas automatiskt när sessionen avslutas. Om din webbläsare inte stöder detta växlar vi automatiskt till vår enklare anonymiserande proxy: du förblir skyddad så länge du följer länkar på sidan, men du kan inte ange en ny adress i adressfältet. Du kan se om du fortfarande är skyddad genom att adressfältet visar: https://proxy.suma-ev.de/?url=här är den faktiska adressen.',
    ],
    'content' => [
    ...
    'privacy' => [
        ...
        '2' => 'Ingen av dessa används, lagras, behålls eller behandlas på annat sätt här på MetaGer (undantag: kortvarig lagring för skydd mot hackning och botattacker). Eftersom vi anser att detta ämne är extremt viktigt har vi också skapat sätt att hjälpa dig att uppnå högsta säkerhetsnivå: MetaGer TOR Hidden Service och vår anonyma webbläsare.',
