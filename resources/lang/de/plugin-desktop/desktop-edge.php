<?php
    return[
        ...
        'default-search-v15.1' => 'Klicken Sie in Ihrem Browser oben rechts auf "<i class="fa fa-cog" aria-hidden="true"></i>" und wählen Sie "Einstellungen".',
        ...
        'default-search-v80.1' => 'Klicken Sie <a href="edge://settings/searchEngines" target="_blank">hier</a> um in die Suchmaschineneinstellungen zu gelangen.',
        ...
        'default-page-v80.1' => 'Klicken Sie <a href="edge://settings/onStartup" target="_blank">hier</a> um in die Einstellungen "Beim Start" zu gelangen.',
