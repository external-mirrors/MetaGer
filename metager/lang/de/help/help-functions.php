...
return [
    ...
    'title' => 'MetaGer - Hilfe',
    "selist" => [
        'title' => 'MetaGer zur Suchmaschinenliste des Browsers hinzufügen <a title="Zur leichten Hilfe" href="/hilfe/easy-language/functions#selist" ><img class="easy-help-icon lm-only" src="/img/help-questionmark-icon-lm.svg"/><img class="easy-help-icon dm-only" src="/img/help-questionmark-icon-dm.svg"/></a>',
    ...
    "stopworte" => [
        "title" => 'Stoppworte <a title="Zur leichten Hilfe" href="/hilfe/easy-language/functions#stopwordsearch" ><img class="easy-help-icon lm-only" src="/img/help-questionmark-icon-lm.svg"/><img class="easy-help-icon dm-only" src="/img/help-questionmark-icon-dm.svg"/></a>',
        "3" => "auto neu -bmw",
    ...
    "key"    => [
        "title" => 'MetaGer Schlüssel hinzufügen <a title="Zur leichten Hilfe" href="/hilfe/easy-language/functions#keyexplain" ><img class="easy-help-icon lm-only" src="/img/help-questionmark-icon-lm.svg"/><img class="easy-help-icon dm-only" src="/img/help-questionmark-icon-dm.svg"/></a>',
    ...
    "mehrwortsuche" => [
        "title" => 'Mehrwortsuche <a title="Zur leichten Hilfe" href="/hilfe/easy-language/functions#severalwords" ><img class="easy-help-icon lm-only" src="/img/help-questionmark-icon-lm.svg"/><img class="easy-help-icon dm-only" src="/img/help-questionmark-icon-dm.svg"/></a>',
        "4" => [
    ...
    "exactsearch" =>[
        "title" => 'Exakte Suche <a title="Zur leichten Hilfe" href="/hilfe/easy-language/functions#exactsearch" ><img class="easy-help-icon lm-only" src="/img/help-questionmark-icon-lm.svg"/><img class="easy-help-icon dm-only" src="/img/help-questionmark-icon-dm.svg"/></a>',
    ...
    "bang"  => [
        "title" => '!bangs <a title="Zur leichten Hilfe" href="/hilfe/easy-language/functions#bangs" ><img class="easy-help-icon lm-only" src="/img/help-questionmark-icon-lm.svg"/><img class="easy-help-icon dm-only" src="/img/help-questionmark-icon-dm.svg"/></a>',
