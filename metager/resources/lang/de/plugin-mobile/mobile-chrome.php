<?php
    return[
        ...
        'default-search-v83.1' => 'Tippen Sie in Ihrem Browser oben rechts auf "<img class= "mg-icon" src="/img/ellipsis.svg">" um das Browsermenü zu öffnen.',
        ...
        'default-page-v83.1' => 'Tippen Sie in Ihrem Browser oben rechts auf "<img class= "mg-icon" src="/img/ellipsis.svg">", um das Browsermenü zu öffnen.',
