...
return [
    ...
    'key' => [
        ...
        'description_second' => 'För att börja, gå helt enkelt till vår [startsida](:startpage_link). Skriv in ovanstående nyckel där och skicka den genom att klicka på "Registrera med nyckel". Du kan göra samma sak genom att hämta följande URL för inställningar i din webbläsare:',
