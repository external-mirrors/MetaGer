...
return [
    ...
    "datenschutz" => [
        ...
        "3" => 'Find more about the topic at <a href="/hilfe/easy-language/privacy-protection#eh-torhidden">Tor Hidden Service</a>. <br> To learn more about <strong>open anonymously</strong>, check out <a href="/hilfe/easy-language/privacy-protection#eh-proxy">MetaGer-Proxy</a>. <br> You can access these features under <strong>Services</strong> in the navigation bar.',
    ],
    "tor" => [
        "title" => "Tor Hidden Service",
        "1" => "Tor Hidden Service is the safest way to use MetaGer. <br> However, you need the Tor Browser for it. <br> You can download the Tor Browser here: <br><a href=\"https://www.torproject.org/\" target=\"_blank\" rel=\"noopener\">https://www.torproject.org</a>. <br> Once the Tor Browser is downloaded, you can use the Tor Hidden Service here: <br><a href=\"https://metager.de/tor/\" target=\"_blank\" rel=\"noopener\">https://metager.de/tor</a>.",
        "2" => "MetaGer can be accessed through the Tor Browser using this link: <br> http://metagerv65pwclop2rsfzg4jwowpavpwd6grhhlvdgsswvo6ii4akgyd.onion",
    ],
    "proxy" => [
        "title" => "MetaGer-Proxy (open anonymously)",
        "1" => "With our MetaGer-Proxy, you can open web pages anonymously. <br> That means you remain unrecognized. <br> The MetaGer-Proxy acts as a protective shield. <br> If you want to search anonymously, follow these steps: <br> In the search results, there is a button <strong>open anonymously</strong>. <br> Here's how the button looks:",
