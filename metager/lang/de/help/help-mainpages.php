...
return [
    ...
    "result"        => [
        "info"       => [
            ...
            "more" => '<img class="help-ellipsis-image lm-only" src="/img/ellipsis.svg"/> <img class="help-ellipsis-image dm-only" src="/img/ellipsis-dm.svg"/>: Wenn Sie auf<img class="help-ellipsis-image lm-only" src="/img/ellipsis.svg"/> <img class="help-ellipsis-image dm-only" src="/img/ellipsis-dm.svg"/>klicken, dann erhalten Sie neue Optionen; das Aussehen des Ergebnisses ändert sich:',
