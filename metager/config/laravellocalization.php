...
return [
    ...
    'supportedLocales' => [
        ...
        'en-UK'       => ['name' => 'English (UK)',        'script' => 'Latn', 'native' => 'British English', 'regional' => 'en_UK'],
        //'en-CA'       => ['name' => 'Canadian English',       'script' => 'Latn', 'native' => 'Canadian English', 'regional' => 'en_CA'],
        'en-US'       => ['name' => 'English (US)',           'script' => 'Latn', 'native' => 'U.S. English', 'regional' => 'en_US'],
        'en-IE'       => ['name' => 'English (Ireland)',           'script' => 'Latn', 'native' => 'Irish English', 'regional' => 'en_IE'],
        'es-ES'          => ['name' => 'Spanish (Spanien)',                'script' => 'Latn', 'native' => 'español', 'regional' => 'es_ES'],
