...
return [
    ...
    "searchword-associator" => [
        ...
        "title" => 'Suchwortassoziator <a title="Zur einfachen Hilfe" href="/hilfe/easy-language/services#asso" ><img class="easy-help-icon lm-only" src="/img/help-questionmark-icon-lm.svg"/><img class="easy-help-icon dm-only" src="/img/help-questionmark-icon-dm.svg"/></a>',
    ],
    "title" => 'MetaGer - Hilfe',
    "widget" => [
        ...
        "title" => 'MetaGer Widget <a title="Zur einfachen Hilfe" href="/hilfe/easy-language/services#widget" ><img class="easy-help-icon lm-only" src="/img/help-questionmark-icon-lm.svg"/><img class="easy-help-icon dm-only" src="/img/help-questionmark-icon-dm.svg"/></a>',
    ],
];
