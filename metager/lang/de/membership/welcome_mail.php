...
return [
    ...
    'membership' => [
        ...
        'description' => 'Diese E-Mail ist gleichzeitig die Bestätigung Ihrer Mitgliedschaft. Bitte bestätigen Sie kurz, dass Sie diese Mail erhalten haben. Ihr Mitgliedsbeitrag i.H.v. **:amount€** ist erstmalig zum **:due** fällig.',
        'banktransfer' => 'Bitte überweisen Sie uns diesen **:interval** unter Angabe des Verwendungszwecks (**:mandate**) auf folgendes Konto:',
        'directdebit' => 'Wir buchen diesen **:interval** mit der Mandatsreferenz **:mandate** von Ihrem Konto **:iban** ab.',
        'paypal' => 'Wir buchen diesen **:interval** vom angegebenen PayPal Konto ab.',
        'card' => 'Wir buchen diesen **:interval** von der angegebenen Kreditkarte ab.',
    ...
    'key' => [
        ...
        'description_first' => 'Für die Einrichtung der Suche mit MetaGer benötigen Sie den folgenden Schlüssel, mit dem Sie sich auf beliebig vielen Geräten anmelden können. Er kann ab sofort verwendet werden. Alles darüber finden Sie auf unseren [Infoseiten](:infos). Ihr neuer Mitgliederschlüssel wird automatisch jeden Monat im Wert von **10,00€** von uns ohne weitere Kosten aufgeladen. Der Schlüssel lautet:',
        'description_second' => 'Um zu starten, gehen Sie einfach auf unsere [Startseite](:startpage_link). Dort geben Sie obigen Schlüssel ein und schicken ihn ab, indem Sie auf „Mit Schlüssel anmelden“ klicken. Das Gleiche erreichen Sie, indem Sie folgende Einstellungs-URL im Webbrowser aufrufen:',
