...
return [
    ...
    "searchfield" => [
        ...
        "suggest" => [
            ...
            "description" => "You can receive a list of autocompleted search queries to chose from while typing in our search field. In our settings you have several options to modify your experience: This feature is disabled by default.",
            "provider" => "<b>Provider:</b> Select the provider for search suggestions you would like MetaGer to query. Different providers have different cost. Also you can disable search suggestions completely.",
            "delay" => "<b>Delay:</b> Any other request coming in during the selected timerange will abort all pending previous requests. Aborted requests will have no cost and you will only see suggestions for the latest request. You can choose between Short (:short), Medium (:medium) and Long (:long)",
            "addressbar" => "<b>Address Bar:</b> If MetaGer is the default searchengine in your browser it can request search suggestions whilst typing in the address bar. If this option is enabled MetaGer will provide suggestions to those calls. Due to how this mechanic is implemented by the browsers we need to store your suggestion settings on our servers together with a temporary pseudomized device identifier. This feature is therefor disabled by default.",
        ],
    ],
    "settings" => [
