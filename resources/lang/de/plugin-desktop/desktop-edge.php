<?php
    return[
        ...
        'default-search-v15.1' => 'Klicken Sie in Ihrem Browser oben rechts auf "<img class= "mg-icon" src="/img/ellipsis-horizontal.svg">" und wählen Sie "Einstellungen".',
        ...
        'default-search-v18.1' => 'Klicken Sie in Ihrem Browser oben rechts auf "<img class= "mg-icon" src="/img/ellipsis-horizontal.svg">" und wählen Sie "Einstellungen".',
        ...
        'default-search-v80.2' => 'Klicken Sie neben dem Eintrag von MetaGer auf "<img class= "mg-icon" src="/img/ellipsis-horizontal.svg">" und wählen Sie "Als Standard".',

        'default-page-v15.1' => 'Klicken Sie oben rechts im Browser auf "<img class= "mg-icon" src="/img/ellipsis-horizontal.svg">" und öffnen Sie die "Einstellungen".',
        ...
        'default-page-v15.3' => 'Klicken Sie auf <img class= "mg-icon" src="/img/floppy.svg">, um MetaGer als Standardsuchmaschine zu speichern.',
        ...
        'default-page-v80.3' => 'Hinweis: Alle hier sichtbaren Webseiten werden nun beim Start des Browsers geöffnet. Sie können Einträge entfernen, indem Sie mit der Maus darüber fahren und rechts auf "<img class= "mg-icon" src="/img/ellipsis-horizontal.svg">" klicken.',
