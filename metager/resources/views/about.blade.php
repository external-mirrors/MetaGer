...
<div class="card">
	...
	<h3><img id="about-lock" src="/img/lock.svg"> @lang('about.points.0.heading')</h3>
	<p>@lang('about.points.0.text')</p>

	<h3><img id= "about-heart" src="/img/heart.svg"> @lang('about.points.1.heading')</h3>
	<p>@lang('about.points.1.text')</p>

	<h3><img id= "about-rainbow" src="/img/rainbow.svg"> @lang('about.points.2.heading', ["transparenz" => LaravelLocalization::getLocalizedURL(LaravelLocalization::getCurrentLocale(), "transparency")])</h3>
	<p>@lang('about.points.2.text')</p>

	<h3><img id="about-leaf" src="/img/leaf.svg"> @lang('about.points.3.heading')</h3>
	<p>@lang('about.points.3.text')</p>
</div>
<div class="card">
