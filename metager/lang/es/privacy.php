...
return [
    ...
    'contexts' => [
        'metager' => [
            ...
            'advertisers' => 'Además de las donaciones y las cuotas de afiliación, debemos financiar nuestras operaciones mediante publicidad no personalizada en la página de resultados. Para recibir esta publicidad, cedemos los dos primeros bloques de la IP en relación con partes del denominado agente de usuario a nuestros socios publicitarios.',
            'clarity' => 'Trabajamos con Microsoft Clarity y Microsoft Advertising para ofrecerle gratuitamente resultados de búsqueda y publicidad de Yahoo. Para ello, se registran datos de uso con fines estadísticos en la página de resultados de MetaGer.',
        ],
