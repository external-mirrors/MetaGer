...
@section('content')
	...
	<div class="card-medium">
		<h2>{{ trans('websearch.head.7') }} <button id="copyButton" class="btn btn-default" type="button"><img class= "widget-mg-icon mg-icon" src="/img/icon-paperclip.svg"> {{ trans('websearch.head.copy') }}</button></h2>
