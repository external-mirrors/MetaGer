...
return [
    'membership' => [
        ...
        'due' => 'Förfallodag',
        'description' => 'Detta e-postmeddelande är också en bekräftelse på ditt medlemskap. Vänligen bekräfta kortfattat att du har mottagit detta e-postmeddelande. Din medlemsavgift på **:belopp** förfaller till betalning första gången på **:förfallodag**.',
    ...
    'key' => [
        ...
        'description_first' => 'För att ställa in sökningen med MetaGer behöver du följande nyckel, som du kan använda för att logga in på valfritt antal enheter. Den kan användas omedelbart. Du kan hitta allt om det på våra [infosidor](:infos). Din nya medlemsnyckel kommer automatiskt att fyllas på av oss varje månad till ett värde av **:belopp** utan extra kostnad. Nyckeln är',
        'description_second' => 'Den enhet som du skickade in din ansökan med har automatiskt blivit inloggad. För att logga in fler enheter, gå till vår [startsida](:startsida_länk). Skriv in ovanstående nyckel där och skicka den genom att klicka på "Registrera med nyckel". Du kan göra samma sak genom att hämta följande URL för inställningar i din webbläsare:',
