...
/**
 * We revert all card memberships as we cannot debit the stored cards
 * This mail will notify the user after we reset the payments method
 * and gives the chance to update their payment information.
 */
class PaymentMethodCard extends Mailable
{
    ...
    {
        $subject = __("membership/mails/payment_method_card.subject");
    ...
    {
        return new Content(
            markdown: 'mail.membership.payment_method_card',
            with: [
