...
return [
    ...
    'query.alteration' => 'Contains results for <a href=":link">:alteration <i class="fa fa-search"></i></a>',
    'query.alteration.original' => 'Instead search for <a href=":link">:original <i class="fa fa-search"></i></a>',
];
