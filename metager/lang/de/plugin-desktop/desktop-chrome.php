<?php
    return[
        ...
        'default-search-v49.1' => 'Klicken Sie in Ihrem Chrome oben rechts auf <img class= "mg-icon" src="/img/menu.svg"> und im folgenden Menü auf "Einstellungen", um die Einstellungen Ihres Chromes zu öffnen.',
        ...
        'default-search-v53.1' => 'Klicken Sie in Ihrem Chrome oben rechts auf <img class= "mg-icon" src="/img/ellipsis.svg"> und im folgenden Menü auf "Einstellungen", um die Einstellungen Ihres Chromes zu öffnen.',
        ...
        'default-search-v59.1' => 'Klicken Sie in Ihrem Chrome oben rechts auf <img class= "mg-icon" src="/img/ellipsis.svg"> und im folgenden Menü auf "Einstellungen", um die Einstellungen Ihres Chromes zu öffnen.',
        'default-search-v59.2' => 'Im Bereich "Suchmaschine" klicken Sie auf "Suchmaschinen verwalten..."',
        'default-search-v59.3' => 'In der nun angezeigten Liste, finden Sie den Eintrag "MetaGer". Fahren Sie mit der Maus über den Eintrag und klicken rechts auf <img class= "mg-icon" src="/img/ellipsis.svg"> und anschließend auf "Als Standard festlegen"',

        'default-page-v49.1' => 'Klicken Sie oben rechts im Browser auf <img class= "mg-icon" src="/img/ellipsis.svg"> und öffnen Sie die "Einstellungen".',
