...
return [
    "title"                 => 'MetaGer - Help in easy language',
    "backarrow"             => 'Back',
    ...
    "result" => [
        ...
        "info" => [
            ...
            "more" => [
                "title" => 'More:',
                "1" => 'When you click on <strong>MORE</strong>, there are new options. <br> The result will look different. <br> It will look like this:',
            ],
